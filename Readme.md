...
<!-- Animated Yellow + Silver Stars Banner (custom SVG) -->
...
flowchart TD
    ...
    subgraph IntelligenceLayer["🧠 AI / ML & IoT Processing"]
        NPKEngine["🧪 NPK Soil & Fertilizer Engine (XGBoost)"]:::yellow
        CropHealth["🌿 Plant Disease Vision Model (CNN/ResNet)"]:::yellow
        YieldPredictor["📈 Yield & Price Forecasting (LSTM)"]:::yellow
        IoTGateway["📡 ESP32 Gateway (Soil NPK, Moisture, DHT22)"]:::yellow
    end
    ...
    FastAPI --> NPKEngine & CropHealth & YieldPredictor & IoTGateway
    IntelligenceLayer --> MongoDB
    FastAPI --> Blockchain
    FastAPI -->|Instant Actionable Insights| ClientLayer
```
